      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-1">
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3">{COMPANY_INFO.name}</h3>
          ...
          {/* Company Links */}
          <div>
            <h4 className="text-sm font-medium text-gray-900 dark:text-white mb-3">Company</h4>
          ...
          {/* Resources Links */}
          <div>
            <h4 className="text-sm font-medium text-gray-900 dark:text-white mb-3">Resources</h4>
            <ul className="space-y-2">
        ...
        <div className="pt-6 border-t border-gray-200 dark:border-gray-700">
          ...
          <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-800">
            <div className="flex flex-wrap justify-center space-x-6 text-xs text-gray-500 dark:text-gray-400">
